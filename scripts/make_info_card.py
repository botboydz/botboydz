...
# ===========================================================================
HOST = "botboydz"   # shown as  botboydz@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "M.Sc. Student, Algeria"),
    ("kv", "Thesis", "Cloud Sched. — Evolutionary Multitasking"),
    ("kv", "Also", "Indie SaaS & Game Dev"),
    ("kv", "Edu", "M.Sc. Computer Science"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "FastAPI, Flask, PostgreSQL"),
    ("kv", "Frontend", "React, TypeScript, Tailwind"),
    ("kv", "Game Dev", "Godot 4, GDScript"),
    ("kv", "Infra", "Docker, WebSockets, n8n"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "SentinelX AI — full SOC/SIEM platform, live detection"),
    ("bul", "Ashen Realms — Godot 4 RPG, 10 classes, 6 bosses"),
    ("bul", "MFEA-MT: evolutionary multitasking for cloud scheduling"),
]
